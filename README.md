...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/copulas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14525&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/copulas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `copulas` can be installed with:

```
conda install copulas
```

It is possible to list all of the versions of `copulas` available on your platform with:
